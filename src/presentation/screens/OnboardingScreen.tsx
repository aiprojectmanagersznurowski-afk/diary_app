...
export const OnboardingScreen = () => {
  ...
  if (showConfetti) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background, justifyContent: 'center', alignItems: 'center' }]}>
        ...
        <ConfettiCannon count={250} origin={{x: width/2, y: -20}} colors={['#A78BFA', '#F472B6', '#60A5FA']} fadeOut />
      </View>
    );
  }
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <TouchableOpacity 
        style={[styles.backButton, { borderColor: colors.tileBorder, backgroundColor: theme === 'AppleLight' ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.04)' }]} 
      ...
      <View style={styles.header}>
        <View style={[styles.sparkleWrapper, { borderColor: colors.tileBorder, backgroundColor: theme === 'AppleLight' ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.1)' }]}>
      ...
      <View style={styles.questionContainer}>
        <GlassCard intensity={theme === 'AppleLight' ? 60 : 30} style={styles.card}>
          <Text style={[styles.stepIndicator, { color: colors.primary }]}>KROK {currentStep + 1} Z {ONBOARDING_QUESTIONS.length}</Text>
      ...
      <View style={styles.bottomContainer}>
        {isProcessing && (
          <View style={[styles.processingPill, { borderColor: colors.tileBorder, backgroundColor: theme === 'AppleLight' ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.1)' }]}>
