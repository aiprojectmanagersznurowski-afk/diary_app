...
description: "Rola Agent OS \"edge\" (Edge Functions i warstwa AI): Supabase Edge Functions (Deno), _shared/ai, wersjonowane prompty, schematy zod i testy deno w Vocaly. Stosuj, gdy bieżące zadanie ma role: edge."
---
...
Uprawnienia zapisu roli (contracts/roles.yaml): `supabase/functions/**`, `supabase/config.toml`, `supabase/.gitignore`, `.env.example`
