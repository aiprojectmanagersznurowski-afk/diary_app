...
description: "Rola Agent OS \"planner\" (Planista): Rozpisuje fazy roadmapy Vocaly na kontrakty zadań, prowadzi ADR i otwarte kwestie. Nie pisze kodu. Stosuj, gdy bieżące zadanie ma role: planner."
---
...
Uprawnienia zapisu roli (contracts/roles.yaml): `docs/**`, `.agent-os/tasks/**`, `.agent-os/handoff/**`
