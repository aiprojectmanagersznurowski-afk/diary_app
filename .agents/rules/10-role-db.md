...
description: "Rola Agent OS \"db\" (Baza danych (Supabase Postgres)): Migracje, RLS, indeksy, RPC, Storage, pg_cron i webhooki bazy w Vocaly. Stosuj, gdy bieżące zadanie ma role: db."
---
...
Uprawnienia zapisu roli (contracts/roles.yaml): `supabase/migrations/**`, `supabase/seed.sql`, `supabase/tests/**`, `supabase/config.toml`, `supabase/.gitignore`
