...
argument_hint: "<ID zadania, np. F1-08> albo puste = następne wolne"
---
Rozpoczynasz pracę jako **{{AGENT}}** w Agent OS projektu Vocaly. Argument: `{{ARGS}}`.
...
2. Uruchom `node .agent-os/scripts/task.mjs start <ID> --agent {{AGENT}}`.
