...
argument_hint: "[krótka notatka]"
---
Kończysz sesję jako **{{AGENT}}**. Następna sesja może być prowadzona przez innego agenta, który nie zna tej rozmowy: wszystko, co ważne, musi być w repozytorium.
...
4. `node .agent-os/scripts/task.mjs handoff --agent {{AGENT}} {{ARGS}}` (dopisuje wpis w „Sesje”).
